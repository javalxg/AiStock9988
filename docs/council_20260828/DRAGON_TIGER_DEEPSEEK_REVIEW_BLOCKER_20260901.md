...
5. `deepseek_reset_v3_review_resume` was used for a final live service check on
   the third consecutive goal turn and terminated with upstream HTTP 502 before
   returning text.
