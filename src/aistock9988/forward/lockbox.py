...
class ForwardLockbox:
    ...
    def append(self, frames: dict[str, pd.DataFrame], *, bundle_id: str, freeze_data_cutoff: str,
        ...
        manifest = {
            "schema_version": "forward-lockbox-v2",
            "experiment_id": self.experiment_id,
            "config_sha256": self.config_sha256,
            "bundle_id": str(bundle_id),
            "freeze_data_cutoff": str(freeze_data_cutoff),
