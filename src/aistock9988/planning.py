...
from .configuration import ModelConfig, StrategyConfig, validate_strategy_model
...
def compile_run_plan(
    ...
    validate_strategy_model(strategy, model)
    ...
    if required_exit_index > execution_index:
